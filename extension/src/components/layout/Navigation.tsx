import { Search, LayoutDashboard, FolderOpen, History, Settings, SearchCheck, Download } from 'lucide-react';

type TabId = 'explorer' | 'builder' | 'templates' | 'history' | 'settings' | 'validator' | 'export';
