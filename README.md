...
[![Manifest V3](https://img.shields.io/badge/Manifest-V3-4285F4?logo=googlechrome&logoColor=white)](https://developer.chrome.com/docs/extensions/develop/concepts/manifest-v3)
...
> **v2.0.0** &middot; [MIT License](LICENSE) &middot; Chrome Extension (Manifest V3)
...
| 11 | Natural language query parser | Done |
| 12 | Engine-specific operator scoping | Done |
| 13 | Chrome Web Store publication | Planned |
